...
class StudyMaterial(Base, TimestampMixin):
    ...
    extraction_method: Mapped[str | None] = mapped_column(String, nullable=True)  # "ocr" or "pdf_text"
...
class ExamResult(Base, TimestampMixin):
    ...
    topic: Mapped[str] = mapped_column(String, nullable=False)  # e.g. "Trigonometry" under MATHEMATICS
